...
PARAMETERS = MappingProxyType(
    {
        ...
        "csv_path_vertex_data": "testcases/paper_lmc_plos/balbC_B_mod_b/balbC_B_mod_b_pre_001/data/node_data.csv",
        "csv_path_edge_data": "testcases/paper_lmc_plos/balbC_B_mod_b/balbC_B_mod_b_pre_001/data/edge_data.csv",
        "csv_path_boundary_data": "testcases/paper_lmc_plos/balbC_B_mod_b/balbC_B_mod_b_pre_001/data/boundary_node_data.csv",
        ...
        # Write options
        "write_path_igraph": "testcases/paper_lmc_plos/balbC_B_mod_b/balbC_B_mod_b_pre_001/output/balbC_B_mod_b_results",  # only required for "write_network_option" 2, 3, 4
    }
)
