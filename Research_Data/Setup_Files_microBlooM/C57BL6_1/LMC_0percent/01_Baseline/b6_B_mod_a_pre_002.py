...
PARAMETERS = MappingProxyType(
    {
        ...
        "csv_path_vertex_data": "testcases/paper_lmc_plos/b6_B_mod_a/b6_B_mod_a_pre_002/data/node_data.csv",
        "csv_path_edge_data": "testcases/paper_lmc_plos/b6_B_mod_a/b6_B_mod_a_pre_002/data/edge_data.csv",
        "csv_path_boundary_data": "testcases/paper_lmc_plos/b6_B_mod_a/b6_B_mod_a_pre_002/data/boundary_node_data.csv",
        ...
        # Write options
        "write_path_igraph": "testcases/paper_lmc_plos/b6_B_mod_a/b6_B_mod_a_pre_002/output/b6_B_mod_a_pre_002_results",  # only required for "write_network_option" 2, 3, 4
    }
)
