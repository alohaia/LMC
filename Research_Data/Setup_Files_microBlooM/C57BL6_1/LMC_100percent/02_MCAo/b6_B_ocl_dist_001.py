...
PARAMETERS = MappingProxyType(
    {
        ...
        "csv_path_vertex_data": "testcases/paper_lmc_plos/b6_B/b6_B_ocl_dist_001/data/node_data.csv",
        "csv_path_edge_data": "testcases/paper_lmc_plos/b6_B/b6_B_ocl_dist_001/data/edge_data.csv",
        "csv_path_boundary_data": "testcases/paper_lmc_plos/b6_B/b6_B_ocl_dist_001/data/boundary_node_data.csv",
        ...
        # Write options
        "write_path_igraph": "testcases/paper_lmc_plos/b6_B/b6_B_ocl_dist_001/output/b6_B_ocl_dist_001_results",  # only required for "write_network_option" 2, 3, 4
        ...
        "csv_path_distensibility": "testcases/paper_lmc_plos/b6_B/b6_B_ocl_dist_001/data/b6_B_ocl_dist_001_properties.csv",
...
import pandas as pd
diameter_baseline = pd.read_csv("testcases/paper_lmc_plos/b6_B/b6_B_ocl_dist_001/data/b6_B_diameters_pre_stroke.csv")["d_base"].to_numpy()
