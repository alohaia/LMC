...
graph_surface_artery = igraph.Graph.Read_Pickle('nw_output/graph_gen_process/a1_test_1_surface_network.pkl')
...
graph_sa_da_av.write_pickle('nw_output/graph_gen_process/a2_test_1_sa_da_av_network.pkl')
write_vtp(graph_sa_da_av, 'nw_output/graph_gen_process/a2_test_1_sa_da_av_network.vtp', coordinatesKey='coords')
