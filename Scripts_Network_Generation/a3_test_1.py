...
from source.graph_manipulation import add_capillary_bed, remove_regions_outside_DAs
...
graph_sa_da_av = igraph.Graph.Read_Pickle('nw_output/graph_gen_process/a2_test_1_sa_da_av_network.pkl')
...
graph_final.write_pickle('nw_output/graph_gen_process/test_1_semi_realistic_network_final.pkl')
write_vtp(graph_final, 'nw_output/graph_gen_process/test_1_semi_realistic_network_final.vtp', coordinatesKey='coords')
